...
public class MainAccountViewHolder extends AbsMainViewHolder{

    public MainAccountViewHolder(Context context, ViewGroup parent) {
...
// Hàm này để set layout cho class này
    ...
    protected int getLayoutId() {
        return R.layout.view_main_account;
    }
